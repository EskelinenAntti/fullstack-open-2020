...
describe('favourite blog', () => {
  ...
  test('of list with one blog equals to the blog', () => {
    expect(listHelper.favouriteBlog([blogs[2]])).toEqual(blogWithMostLikes)
  })
...
describe('most blogs', () => {
  ...
  test('of list with one blog returns the author of the single blog', () => {
    ...
    expect(listHelper.mostBlogs([blogs[0]])).toEqual(authorOfSingleBlog)
  })
